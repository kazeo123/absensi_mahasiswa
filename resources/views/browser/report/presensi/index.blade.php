    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-6">
                    <label class="form-label" for="datepicker">Nama Karyawan</label>
                    <div class="input-group mb-3"><span class="input-group-text"><i class="fas fa-user-alt"></i></span>
...
<script>
    $(document).ready(function() {
        ...
        function cetak() {
            ...
            window.open(`{{ url('cetak_presensi') }}?bulan=${bulan}&tahun=${tahun}&nik=${nik}`, '_blank');
        }
</script>
@endsection